...
export default function() {
    ...
    function createNodes(rawData) {
        ...
        const minAmount = d3.min(rawData, d => +d.count);
        const maxAmount = d3.max(rawData, d => +d.count);
    ...
    function ticked() {
        ...
        if(selectedNode !== null) {
            const bubble = d3.select('#bubble-'+selectedNode);
            centerBorder
                .attr('cx', bubble.attr('cx'))
                .attr('cy', bubble.attr('cy'));
        }
    }
    ...
    return function chart(selector, rawData) {
        ...
        const bubblesE = bubbles.enter().append('circle')
            ...
            .attr('r', 0)
            .on('click', function() {
                selectNode(d3.select(this).datum().id);
            });
